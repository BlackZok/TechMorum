...
let infoContHtml = generalInfoCont.map((a) => {
    ...
    <div class="col-md-4">
        <div class="infocot">
            ...
            <button data-custom-open="order"  style="padding: 5px 10px; font-weight: 500; background-color: #FF7C00; border: transparent; border-radius: 5px; color: white;">Заказать</button>
            <button data-custom-open="contact" style=" color: white; font-weight: 400; padding: 100px 10px; background-color: transparent; border: transparent;">Узнать цены</button>
        </div>
    </div>
    `
}).join(" ");
