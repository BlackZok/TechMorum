...
let headertexHtml = generalHeadertex.map((a) => {
    ...
    <div class="col-md-4">  
        <div class = "vbn">
            ...
            <p style="font-size: 30px;font-weight: 1000;color: white; margin: 20px 0px 0px 0px"> ${a.title} </p>
            <p style="font-size: 30px;font-weight: 1000;color: #FF7C00; margin: 0px 0px 0px 0px"> ${a.titlle} </p>
            <p style="font-size: 30px;font-weight: 1000;color: white; margin: 0px 0px 20px 0px"> ${a.titllle} </p>
